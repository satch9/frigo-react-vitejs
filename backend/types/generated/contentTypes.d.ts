...
export interface ApiInventoryItemInventoryItem
  ...
  attributes: {
    ...
    household: Schema.Attribute.Relation<
      ...
      'api::household.household'
    >;
    household_item: Schema.Attribute.Relation<
      'oneToOne',
      'api::household.household'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiStockageZoneStockageZone
  extends Struct.CollectionTypeSchema {
  collectionName: 'stockage_zones';
  info: {
    displayName: 'Stockage zone';
    pluralName: 'stockage-zones';
    singularName: 'stockage-zone';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::stockage-zone.stockage-zone'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::stockage-zone.stockage-zone': ApiStockageZoneStockageZone;
